...
public class controller implements Initializable{
    ...
    @FXML
    private Button login, defaultLogin;
  ...
  */
  public void Enter(ActionEvent enter) throws IOException {
    ...
    public void useDefaultAccount(ActionEvent e) throws IOException{
        AccountManager.setCurrentAccount(AccountManager.getAccount("DonutLover@DuffBeer.com", "donuts123"));
        //Main.switchView("allListings.fxml");
        root = FXMLLoader.load(getClass().getResource("successfulLogin.fxml"));
