...
public class PostNewCarController implements Initializable {
    ...
    private ExtensionFilter ex = new ExtensionFilter("Images", "*.jpg");
    ...
    public void addCarPics(ActionEvent e){
        ...
        File directory = new File("F:\\Comp380Project\\src\\CarPics");
        ...
        try {
            ...
            pictures.add(image);
            uploadStatus.setText("Successfully Added Image");
        } catch (IOException exception) {
            uploadStatus.setText("Error Occurred!");
        }
    }
    ...
    public void postCar(ActionEvent e) throws IOException{
        ...
        AccountManager.currentAccount.postNewListing(carInfo, pictures);
        switchToAllListings(e);
    }
